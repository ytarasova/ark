...
interface LayoutProps {
  ...
  /** Middle column -- persistent 320px session list (or other context list). */
 ...
 *
 * The 60px icon rail is always mounted. The 320px middle column (session list
...
export function Layout({
  ...
  return (
    <div
      ...
      style={{
        display: "grid",
        gridTemplateColumns: list ? "60px 320px 1fr" : "60px 1fr",
      }}
    >
      <IconRail
        items={navItems}
