...
export const DEFAULT_MODELS: ModelConfig[] = [
  // Anthropic
  { id: "claude-opus-4-6",   provider: "anthropic", tier: "frontier", cost_input: 15.0,  cost_output: 75.0,  max_context: 200000,  supports_tools: true, quality: 0.98 },
  { id: "claude-sonnet-4-6", provider: "anthropic", tier: "standard", cost_input: 3.0,   cost_output: 15.0,  max_context: 200000,  supports_tools: true, quality: 0.92 },
  { id: "claude-haiku-4-5",  provider: "anthropic", tier: "economy",  cost_input: 0.8,   cost_output: 4.0,   max_context: 200000,  supports_tools: true, quality: 0.82 },
  // OpenAI
  { id: "gpt-4.1",           provider: "openai",    tier: "frontier", cost_input: 2.0,   cost_output: 8.0,   max_context: 1000000, supports_tools: true, quality: 0.95 },
  { id: "gpt-4.1-mini",      provider: "openai",    tier: "standard", cost_input: 0.4,   cost_output: 1.6,   max_context: 1000000, supports_tools: true, quality: 0.88 },
  { id: "gpt-4.1-nano",      provider: "openai",    tier: "economy",  cost_input: 0.1,   cost_output: 0.4,   max_context: 1000000, supports_tools: true, quality: 0.75 },
  // Google
  { id: "gemini-2.5-pro",    provider: "google",    tier: "frontier", cost_input: 1.25,  cost_output: 10.0,  max_context: 1000000, supports_tools: true, quality: 0.94 },
  { id: "gemini-2.5-flash",  provider: "google",    tier: "economy",  cost_input: 0.15,  cost_output: 0.6,   max_context: 1000000, supports_tools: true, quality: 0.80 },
];
