...
export function registerScheduleHandlers(router: Router, app: AppContext): void {
  router.handle("schedule/list", async () => ({
    schedules: await core.listSchedules(app),
  }));
