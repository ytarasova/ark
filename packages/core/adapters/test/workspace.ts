/**
 * InMemoryWorkspace adapter -- stub.
 *
 * Slice 1: no-op setup/teardown returning a tmp path; verifies Workspace
 * callers without touching the filesystem.
 */
...
const NOT_MIGRATED = new Error("InMemoryWorkspace: not migrated yet -- Slice 1");
