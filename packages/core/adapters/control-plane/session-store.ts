/**
 * ControlPlaneSessionStore adapter -- stub.
 *
 * Hosted Postgres-backed SessionRepository. Slice 1 migration.
 */

import type { SessionStore } from "../../ports/session-store.js";
import type { Session, CreateSessionOpts, SessionListFilters } from "../../../types/index.js";

const NOT_MIGRATED = new Error("ControlPlaneSessionStore: not migrated yet -- Slice 1");

export class ControlPlaneSessionStore implements SessionStore {
