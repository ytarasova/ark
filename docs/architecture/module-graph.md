...
| module | fan-in |
| --- | --- |
| `packages/core/observability/structured-log.ts` | 174 |
| `packages/core/app.ts` | 152 |
| `packages/types/index.ts` | 103 |
| `packages/web/src/lib/utils.ts` | 95 |
| `packages/core/database/index.ts` | 72 |
| `packages/web/src/hooks/useApi.ts` | 43 |
| `packages/cli/app-client.ts` | 40 |
| `packages/server/router.ts` | 37 |
| `packages/web/src/components/ui/button.tsx` | 35 |
| `packages/protocol/types.ts` | 32 |
| `packages/core/state/flow.ts` | 31 |
| `packages/server/validate.ts` | 29 |
| `packages/core/config.ts` | 28 |
...
- `packages/cli/commands/misc/index.ts`
- `packages/cli/run.ts`
...
- `packages/compute/providers/docker-placement-ctx.ts`
...
- `packages/core/claude/channel-delivery.ts`
- `packages/core/claude/index.ts`
- `packages/core/claude/launcher.ts`
- `packages/core/claude/mcp-config.ts`
- `packages/core/claude/settings.ts`
- `packages/core/claude/trust.ts`
...
- `packages/core/resolution/index.ts`
- `packages/core/resolution/resolve-stage.ts`
- `packages/core/review.ts`
- `packages/core/runtimes/claude-agent/format.ts`
...
- `packages/core/stores/ephemeral-flow-store.ts`
- `packages/core/tickets/providers/bitbucket/index.ts`
- `packages/core/tickets/providers/github/index.ts`
- `packages/core/tickets/providers/jira/index.ts`
...
- `packages/web/src/components/session/SdkTranscriptPanel.tsx`
...
- `packages/web/src/components/ui/radio.tsx`
...
### `packages/arkd/routes/metrics-snapshot.ts`
...
### `packages/cli/commands/compute/create.ts`
...
### `packages/cli/commands/compute/index.ts`

- fan-in: 1
- fan-out: 5
- imports:
  - `packages/cli/commands/compute/create.ts`
  - `packages/cli/commands/compute/lifecycle.ts`
  - `packages/cli/commands/compute/pool.ts`
  - `packages/cli/commands/compute/template.ts`
  - `packages/cli/commands/compute/view.ts`
...
### `packages/cli/commands/misc/acp.ts`
...
### `packages/cli/commands/misc/arkd.ts`
...
### `packages/cli/commands/misc/channel.ts`
...
### `packages/cli/commands/misc/config.ts`
...
### `packages/cli/commands/misc/doctor.ts`
...
- imports:
  ...
  - `packages/cli/commands/misc/config.ts`
  - `packages/cli/commands/misc/doctor.ts`
  - `packages/cli/commands/misc/init.ts`
  - `packages/cli/commands/misc/mcp-proxy.ts`
  - `packages/cli/commands/misc/openapi.ts`
  - `packages/cli/commands/misc/pr.ts`
  - `packages/cli/commands/misc/repo-map.ts`
  - `packages/cli/commands/misc/run-agent-sdk.ts`
  - `packages/cli/commands/misc/watch.ts`
  - `packages/cli/commands/misc/web.ts`
...
- fan-out: 1
- imports:
  - `packages/core/runtimes/claude-agent/launch.ts`
...
- imports:
  - `packages/cli/app-client.ts`
  - `packages/cli/services/web-probe.ts`
...
### `packages/cli/commands/session/export-import.ts`
...
### `packages/cli/commands/session/fork-clone.ts`
...
### `packages/cli/commands/session/index.ts`
...
- imports:
  - `packages/cli/commands/session/export-import.ts`
  - `packages/cli/commands/session/fork-clone.ts`
  - `packages/cli/commands/session/lifecycle.ts`
  - `packages/cli/commands/session/start.ts`
  - `packages/cli/commands/session/view.ts`
...
- imports:
  - `packages/cli/app-client.ts`
  - `packages/cli/services/session-start.ts`
  - `packages/core/index.ts`
  - `packages/core/prereqs.ts`
...
### `packages/cli/commands/token.ts`
...
- imports:
  ...
  - `packages/compute/isolation/devcontainer.ts`
  - `packages/compute/isolation/direct.ts`
  - `packages/compute/isolation/docker.ts`
...
- imports:
  - `packages/compute/core/types.ts`
  - `packages/compute/core/workspace-clone.ts`
...
### `packages/compute/isolation/docker-compose.ts`
...
### `packages/compute/isolation/docker-config.ts`
...
- imports:
  ...
  - `packages/core/observability/structured-log.ts`
  - `packages/core/safe.ts`
  - `packages/core/secrets/deferred-placement-ctx.ts`
  - `packages/core/secrets/placement-types.ts`
...
- imports:
  ...
  - `packages/core/executors/noop.ts`
  - `packages/core/executors/resolve.ts`
  ...
  - `packages/core/services/dispatch/index.ts`
  - `packages/core/services/index.ts`
  - `packages/core/services/session-hooks/index.ts`
  - `packages/core/services/session/index.ts`
  - `packages/core/services/stage-advance/index.ts`
...
### `packages/core/claude/args.ts`

- fan-in: 2
- fan-out: 1
- imports:
  - `packages/core/claude/model.ts`
...
### `packages/core/claude/permissions.ts`
...
- imports:
  ...
  - `packages/core/code-intel/interfaces/types.ts`
  - `packages/core/code-intel/migration-runner.ts`
  - `packages/core/code-intel/store/chunks.ts`
  - `packages/core/code-intel/store/files-symbols.ts`
  - `packages/core/code-intel/store/git-signals.ts`
  - `packages/core/code-intel/store/graph.ts`
  - `packages/core/code-intel/store/indexing-runs.ts`
  - `packages/core/code-intel/store/platform-docs.ts`
  - `packages/core/code-intel/store/repos.ts`
  - `packages/core/code-intel/store/tenants.ts`
  - `packages/core/code-intel/store/types.ts`
  - `packages/core/code-intel/store/workspaces.ts`
  - `packages/core/database/index.ts`
...
- imports:
  - `packages/core/code-intel/interfaces/types.ts`
  - `packages/core/code-intel/schema/chunks.ts`
  - `packages/core/code-intel/store/dialect.ts`
  - `packages/core/code-intel/store/types.ts`
...
- imports:
  ...
  - `packages/core/infra/boot-cleanup.ts`
  ...
  - `packages/core/repositories/event.ts`
  - `packages/core/repositories/flow-state.ts`
  - `packages/core/repositories/ledger.ts`
  ...
  - `packages/core/stores/model-store.ts`
...
- imports:
  ...
  - `packages/core/plugins/registry.ts`
  - `packages/core/repositories/session.ts`
  - `packages/core/runtimes/claude-agent/parser.ts`
...
- imports:
  ...
  - `packages/core/executors/status-poller.ts`
  - `packages/core/models/ModelService.ts`
  - `packages/core/observability/structured-log.ts`
  - `packages/core/observability/usage.ts`
  - `packages/core/plugins/registry.ts`
  - `packages/core/repositories/compute.ts`
  ...
  - `packages/core/services/index.ts`
  - `packages/core/services/plan-artifact.ts`
  - `packages/core/services/session-hooks/index.ts`
  - `packages/core/services/session-output.ts`
  - `packages/core/services/session/index.ts`
  - `packages/core/services/stage-advance/index.ts`
...
### `packages/core/drizzle/from-idb.ts`
...
### `packages/core/executors/claude-agent.ts`
...
- imports:
  ...
  - `packages/core/observability/structured-log.ts`
  - `packages/core/safe.ts`
  - `packages/core/services/review-gate.ts`
  - `packages/core/state/flow.ts`
  - `packages/types/index.ts`
...
### `packages/core/models/Model.ts`

- fan-in: 1
- fan-out: 1
- imports:
  - `packages/types/model.ts`
...
### `packages/core/models/resolver.ts`
...
### `packages/core/runtimes/claude-agent/intervention-tail.ts`
...
- imports:
  - `packages/core/runtimes/claude-agent/intervention-tail.ts`
  - `packages/core/runtimes/claude-agent/mcp-ask-user.ts`
  - `packages/core/runtimes/claude-agent/mcp-stage-control.ts`
  - `packages/core/runtimes/claude-agent/user-message-stream.ts`
...
- imports:
  ...
  - `packages/core/services/actions/types.ts`
  - `packages/core/services/idempotency.ts`
...
### `packages/core/services/dispatch/agent-resolve.ts`

- fan-in: 1
- fan-out: 5
- imports:
  - `packages/core/agent/agent.ts`
  - `packages/core/services/dispatch/types.ts`
  - `packages/core/services/task-builder.ts`
  - `packages/core/state/flow.ts`
  - `packages/types/index.ts`

### `packages/core/services/dispatch/compute-resolve.ts`
...
- imports:
  ...
  - `packages/core/services/dispatch/agent-resolve.ts`
  - `packages/core/services/dispatch/compute-resolve.ts`
  - `packages/core/services/dispatch/dispatch-fanout.ts`
  - `packages/core/services/dispatch/dispatch-foreach.ts`
  - `packages/core/services/dispatch/dispatch-hosted.ts`
  - `packages/core/services/dispatch/guards.ts`
  - `packages/core/services/dispatch/inline-substage.ts`
  - `packages/core/services/dispatch/launch.ts`
  - `packages/core/services/dispatch/post-launch.ts`
  - `packages/core/services/dispatch/secrets-resolve.ts`
...
- fan-out: 5
- imports:
  - `packages/core/services/dispatch/foreach/child-spawner.ts`
  - `packages/core/services/dispatch/foreach/inline-loop.ts`
  - `packages/core/services/dispatch/foreach/spawn-loop.ts`
  - `packages/core/services/dispatch/types.ts`
  - `packages/core/state/flow.ts`
...
### `packages/core/services/dispatch/foreach/budget.ts`
...
### `packages/core/services/dispatch/foreach/checkpoint.ts`
...
- imports:
  ...
  - `packages/core/services/dispatch/foreach/budget.ts`
  - `packages/core/services/dispatch/foreach/checkpoint.ts`
  - `packages/core/services/dispatch/foreach/iteration-vars.ts`
  - `packages/core/services/dispatch/foreach/orchestration.ts`
  - `packages/core/services/dispatch/types.ts`
  - `packages/core/state/flow.ts`
...
### `packages/core/services/dispatch/foreach/list-resolve.ts`
...
### `packages/core/services/session/create.ts`
...
### `packages/core/services/session/fork-clone.ts`
...
- imports:
  - `packages/core/services/session/create.ts`
  - `packages/core/services/session/fork-clone.ts`
  - `packages/core/services/session/review.ts`
...
### `packages/core/services/stage-advance/advance.ts`
...
- imports:
  ...
  - `packages/core/observability/structured-log.ts`
  - `packages/core/services/idempotency.ts`
  - `packages/core/services/stage-advance/types.ts`
  - `packages/core/state/graph-flow.ts`
  - `packages/types/index.ts`

### `packages/core/services/stage-advance/complete.ts`
...
- imports:
  ...
  - `packages/core/services/idempotency.ts`
  - `packages/core/services/stage-advance/advance.ts`
  - `packages/core/services/stage-advance/transcript-parse.ts`
  - `packages/core/services/stage-advance/types.ts`

### `packages/core/services/stage-advance/handoff.ts`
...
### `packages/core/tickets/providers/bitbucket/client.ts`
...
- imports:
  - `packages/core/tickets/providers/bitbucket/client.ts`
  - `packages/core/tickets/providers/bitbucket/normalize.ts`
  - `packages/core/tickets/providers/bitbucket/query.ts`
  - `packages/core/tickets/providers/bitbucket/webhook.ts`
...
### `packages/core/tickets/providers/github/client.ts`
...
- imports:
  - `packages/core/tickets/providers/github/client.ts`
  - `packages/core/tickets/providers/github/normalize.ts`
  - `packages/core/tickets/providers/github/query.ts`
  - `packages/core/tickets/providers/github/webhook.ts`
  - `packages/core/tickets/richtext/markdown.ts`
  - `packages/core/tickets/types.ts`
...
### `packages/core/tickets/providers/jira/client.ts`
...
- imports:
  - `packages/core/tickets/providers/jira/client.ts`
  - `packages/core/tickets/providers/jira/jql.ts`
  - `packages/core/tickets/providers/jira/normalize.ts`
  - `packages/core/tickets/providers/jira/webhook.ts`
...
### `packages/core/tickets/providers/linear/client.ts`
...
- imports:
  - `packages/core/tickets/providers/linear/client.ts`
  - `packages/core/tickets/providers/linear/normalize.ts`
  - `packages/core/tickets/providers/linear/query.ts`
  - `packages/core/tickets/providers/linear/webhook.ts`
  - `packages/core/tickets/richtext/markdown.ts`
  - `packages/core/tickets/types.ts`
...
- fan-out: 17
- imports:
  - `packages/protocol/clients/admin-team.ts`
  - `packages/protocol/clients/admin-tenant.ts`
  - `packages/protocol/clients/agent.ts`
  - `packages/protocol/clients/code-intel.ts`
  - `packages/protocol/clients/compute.ts`
  - `packages/protocol/clients/flow.ts`
  - `packages/protocol/clients/knowledge.ts`
  - `packages/protocol/clients/observability.ts`
  - `packages/protocol/clients/rpc.ts`
  - `packages/protocol/clients/secrets.ts`
  - `packages/protocol/clients/session-interact.ts`
  - `packages/protocol/clients/session.ts`
  - `packages/protocol/clients/system.ts`
  - `packages/protocol/clients/tickets.ts`
  - `packages/protocol/clients/workspace.ts`
  - `packages/protocol/transport.ts`
  - `packages/protocol/types.ts`
...
### `packages/router/adapters/anthropic-adapter.ts`

- fan-in: 1
- fan-out: 2
- imports:
  - `packages/router/adapters/provider-adapter.ts`
  - `packages/router/types.ts`

### `packages/router/adapters/google-adapter.ts`
...
### `packages/router/adapters/index.ts`
...
- imports:
  - `packages/router/adapters/anthropic-adapter.ts`
  - `packages/router/adapters/google-adapter.ts`
  - `packages/router/adapters/openai-adapter.ts`
  - `packages/router/adapters/provider-adapter.ts`
...
- imports:
  - `packages/router/classifier.ts`
  - `packages/router/policies/index.ts`
  - `packages/router/providers.ts`
  - `packages/router/types.ts`
...
### `packages/router/policies/balanced-policy.ts`

- fan-in: 1
- fan-out: 4
- imports:
  - `packages/router/classifier.ts`
  - `packages/router/policies/policy-selector.ts`
  - `packages/router/policies/tier-escalator.ts`
  - `packages/router/types.ts`

### `packages/router/policies/cost-policy.ts`
...
- imports:
  ...
  - `packages/router/policies/cost-policy.ts`
  - `packages/router/policies/policy-selector.ts`
  - `packages/router/policies/quality-policy.ts`
...
### `packages/server/handlers/resource-compute.ts`
...
- fan-out: 7
- imports:
  - `packages/server/mcp/tools/agent.ts`
  - `packages/server/mcp/tools/compute.ts`
  - `packages/server/mcp/tools/flow.ts`
  - `packages/server/mcp/tools/recipe.ts`
  - `packages/server/mcp/tools/secrets.ts`
  - `packages/server/mcp/tools/session.ts`
  - `packages/server/mcp/tools/skill.ts`

### `packages/server/mcp/registry.ts`
...
- imports:
  - `packages/server/mcp/registry.ts`
  - `packages/server/mcp/transport.ts`
...
### `packages/types/flow-progress.ts`
...
- imports:
  ...
  - `packages/web/src/components/agents/AgentForm.tsx`
  - `packages/web/src/components/agents/RuntimeDetailPanel.tsx`
  - `packages/web/src/components/agents/SubTabBar.tsx`
...
- fan-out: 6
- imports:
  - `packages/web/src/components/ui/CostBarChart.tsx`
  - `packages/web/src/components/ui/KpiCard.tsx`
...
- fan-out: 5
- imports:
  - `packages/web/src/components/history/HistoryList.tsx`
  - `packages/web/src/components/history/detail/SessionDetail.tsx`
  - `packages/web/src/components/history/detail/TranscriptDetail.tsx`
  - `packages/web/src/components/history/useHistorySearch.ts`
...
- imports:
  ...
  - `packages/web/src/components/session/new/ComputeDropdown.tsx`
  - `packages/web/src/components/session/new/FlowDropdown.tsx`
  - `packages/web/src/components/session/new/RichTaskInput.tsx`
  - `packages/web/src/components/session/new/references.ts`
  - `packages/web/src/components/session/new/types.ts`
  - `packages/web/src/components/ui/button.tsx`
  - `packages/web/src/components/ui/input.tsx`
  - `packages/web/src/hooks/useFilePreviews.ts`
  - `packages/web/src/hooks/useNewSessionForm.ts`
  - `packages/web/src/providers/AppModeProvider.tsx`
...
- fan-out: 21
- imports:
  - `packages/web/src/components/session/BudgetBar.tsx`
  - `packages/web/src/components/session/ForEachRollup.tsx`
  - `packages/web/src/components/session/HeaderActions.tsx`
  - `packages/web/src/components/session/RejectGateModal.tsx`
  - `packages/web/src/components/session/RestartDialog.tsx`
  - `packages/web/src/components/session/ResumeBanner.tsx`
  - `packages/web/src/components/session/TabFooter.tsx`
  - `packages/web/src/components/session/TabPanels.tsx`
  ...
  - `packages/web/src/hooks/useApi.ts`
  - `packages/web/src/hooks/useRuntimeQueries.ts`
  - `packages/web/src/hooks/useSessionActions.ts`
  - `packages/web/src/hooks/useSessionDetail.ts`
  - `packages/web/src/hooks/useSessionQueries.ts`
  - `packages/web/src/lib/inline-display.ts`
  - `packages/web/src/util.ts`
...
- imports:
  - `packages/types/flow-progress.ts`
  - `packages/web/src/components/SessionRowWithChildren.tsx`
...
- imports:
  - `packages/web/src/themes/ThemeProvider.tsx`
  - `packages/web/src/themes/terminal-theme.ts`
...
### `packages/web/src/components/history/TranscriptMessages.tsx`
...
### `packages/web/src/components/session/AttachedFiles.tsx`
...
### `packages/web/src/components/session/CopyAttachCommandButton.tsx`
...
### `packages/web/src/components/session/ErrorRow.tsx`

- fan-in: 1
- fan-out: 2
- imports:
  - `packages/web/src/components/session/types.ts`
  - `packages/web/src/lib/utils.ts`

### `packages/web/src/components/session/FlowTreePanel.tsx`

- fan-in: 1
- fan-out: 4
- imports:
  - `packages/web/src/hooks/useApi.ts`
  - `packages/web/src/hooks/useSessionTreeStream.ts`
  - `packages/web/src/lib/utils.ts`
  - `packages/web/src/util.ts`
...
- fan-out: 2
- imports:
  - `packages/web/src/components/ui/MenuButton.tsx`
  - `packages/web/src/lib/utils.ts`
...
### `packages/web/src/components/session/LiveTerminalPanel.tsx`
...
- fan-out: 6
- imports:
  - `packages/web/src/components/session/tool-block/index.tsx`
...
### `packages/web/src/components/session/StageGroupHeader.tsx`
...
- fan-out: 13
- imports:
  - `packages/web/src/components/session/tabs/ConversationTab.tsx`
  - `packages/web/src/components/session/tabs/CostTab.tsx`
  - `packages/web/src/components/session/tabs/DiffTab.tsx`
  - `packages/web/src/components/session/tabs/ErrorsTab.tsx`
  - `packages/web/src/components/session/tabs/FlowTab.tsx`
  - `packages/web/src/components/session/tabs/KnowledgeTab.tsx`
  - `packages/web/src/components/session/tabs/LogsTab.tsx`
  - `packages/web/src/components/session/tabs/TerminalTab.tsx`
  - `packages/web/src/components/ui/ContentTabs.tsx`
...
### `packages/web/src/components/session/new/schema.ts`
...
- imports:
  - `packages/web/src/components/session/FlowTreePanel.tsx`
  - `packages/web/src/components/ui/FlowDag.tsx`
  - `packages/web/src/components/ui/StageProgressBar.tsx`
...
### `packages/web/src/components/session/tool-block/icons.tsx`
...
- imports:
  - `packages/web/src/components/session/tool-block/icons.tsx`
  - `packages/web/src/components/session/tool-block/shell.tsx`
  - `packages/web/src/lib/utils.ts`
