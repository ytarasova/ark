...
| `admin/team/create` | `packages/server/handlers/admin.ts` | 105 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/delete` | `packages/server/handlers/admin.ts` | 136 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/get` | `packages/server/handlers/admin.ts` | 97 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/list` | `packages/server/handlers/admin.ts` | 91 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/members/add` | `packages/server/handlers/admin.ts` | 151 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/members/list` | `packages/server/handlers/admin.ts` | 145 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/members/remove` | `packages/server/handlers/admin.ts` | 173 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/members/set-role` | `packages/server/handlers/admin.ts` | 189 | no | packages/protocol/clients/admin-team.ts |
| `admin/team/update` | `packages/server/handlers/admin.ts` | 123 | no | packages/protocol/clients/admin-team.ts |
...
| `admin/tenant/create` | `packages/server/handlers/admin.ts` | 50 | no | packages/protocol/clients/admin-tenant.ts |
| `admin/tenant/delete` | `packages/server/handlers/admin.ts` | 82 | no | packages/protocol/clients/admin-tenant.ts |
| `admin/tenant/get` | `packages/server/handlers/admin.ts` | 42 | no | packages/protocol/clients/admin-tenant.ts |
| `admin/tenant/list` | `packages/server/handlers/admin.ts` | 37 | no | packages/protocol/clients/admin-tenant.ts |
...
| `admin/tenant/set-status` | `packages/server/handlers/admin.ts` | 74 | no | packages/protocol/clients/admin-tenant.ts |
| `admin/tenant/update` | `packages/server/handlers/admin.ts` | 61 | no | packages/protocol/clients/admin-tenant.ts |
| `admin/user/create` | `packages/server/handlers/admin.ts` | 226 | no | packages/protocol/clients/admin-team.ts |
| `admin/user/delete` | `packages/server/handlers/admin.ts` | 244 | no | packages/protocol/clients/admin-team.ts |
| `admin/user/get` | `packages/server/handlers/admin.ts` | 218 | no | packages/protocol/clients/admin-team.ts |
| `admin/user/list` | `packages/server/handlers/admin.ts` | 213 | no | packages/protocol/clients/admin-team.ts |
